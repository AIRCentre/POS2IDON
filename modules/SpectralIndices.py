...
def CalculateAllIndexes(ProductToProcess):
    """
    This function calculates indices (NDVI,FDI,FAI,SI,NDWI,NRD,NDMI,BSI) from input bands and saves as tif file.
    Input:  ProductToProcess - Product folder where the bands to process are located.
